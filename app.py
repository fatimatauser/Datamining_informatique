...
def show_descriptive_stats(df):
    ...
    with tab_bivar:
        ...
        if len(num_cols) >= 2: Isseu Gueye, [1/06/2025 à 08:27]
col1, col2 = st.columns(2)
    ...
    if 'best_n' in st.session_state:
        ...
        if st.button("Exécuter K-means"):
            with st.spinner("Clustering en cours..."):
                ...
                silhouette_avg = silhouette_score(st.session_state.scaled_data, clusters) Isseu Gueye, [1/06/2025 à 08:27]
# Ajout des clusters aux données
            ...
            def echantillonnage(df, n, pas=30, duree=180):
                ...
                return sample_df Isseu Gueye, [1/06/2025 à 08:27]
def prepare_data(df):
            ...
            if 'ARI_scores' in st.session_state:
                ...
                ax.set_title('Évolution de la Stabilité du Modèle') Isseu Gueye, [1/06/2025 à 08:27]
...
def perform_rfm_analysis(df):
    ...
    recommendations = { Isseu Gueye, [1/06/2025 à 08:27]
        ...
        if df is not None:
            ...
            with tab_rfm:
                ...
                if 'df_clean' in st.session_state:
                    ...
                    st.info("Veuillez d'abord nettoyer les données dans l'onglet Statistiques")
    else: Isseu Gueye, [1/06/2025 à 08:27]
